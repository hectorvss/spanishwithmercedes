(function () {
  ...
  var INDEX = [
    ...
    { es:'El Género en Español: Casos Especiales', en:'Gender in Spanish: Special Cases', type:'video', level:'A2-B1', url:'videos.html#video-genero-ii', kw:'género casos especiales masculino femenino irregular excepciones special cases gender' },
    { es:'Todavía, Aún, Ya, Ya No y Todavía No', en:'Todavía, Aún, Ya, Ya No & Todavía No', type:'video', level:'A2-B2', url:'videos.html#video-ya-todavia', kw:'todavia aun ya ya no todavia no tilde still already yet no longer' },
    ...
    { es:'Todavía, Aún, Ya, Ya No y Todavía No', en:'Todavía, Aún, Ya, Ya No & Todavía No', type:'pdf', level:'A2-B2', url:'free-pdf.html#card-ya-todavia', kw:'todavia aun ya ya no todavia no tilde grammar gramatica still already yet' },
    ...
    { es:'Verbos con Preposición: Acordarse, Casarse, Confiar, Darse Cuenta', en:'Verbs with Prepositions: Acordarse, Casarse, Confiar, Darse Cuenta', type:'pdf', level:'A2-B1', url:'free-pdf.html#card-verbos-preposicion', kw:'verbos con preposicion acordarse de casarse con confiar en darse cuenta de pronominales verbs prepositions' },
    { es:'Verbos con Preposición: Acordarse, Casarse, Confiar, Darse Cuenta', en:'Verbs with Prepositions: Acordarse, Casarse, Confiar, Darse Cuenta', type:'video', level:'A2-B1', url:'videos.html#video-verbos-preposicion', kw:'verbos con preposicion acordarse de casarse con confiar en darse cuenta de pronominales verbs prepositions' },
    { es:'Escuchar, Esperar, Buscar, Pedir — Sin Preposición en Español', en:'Listen To, Wait For, Look For, Ask For — No Preposition in Spanish', type:'video', level:'A2-B1', url:'videos.html#video-escuchar-esperar-buscar-pedir', kw:'listen to wait for look for ask for escuchar esperar buscar pedir sin preposicion calco del ingles verbos con preposicion en ingles y no en español' },
    { es:'Escuchar, Esperar, Buscar, Pedir — Sin Preposición en Español', en:'Listen To, Wait For, Look For, Ask For — No Preposition in Spanish', type:'pdf', level:'A2-B1', url:'free-pdf.html#card-verbos-sin-preposicion', kw:'listen to wait for look for ask for escuchar esperar buscar pedir sin preposicion calco del ingles ejercicios soluciones' },
    { es:'El pretérito indefinido irregular de ANDAR', en:'The Irregular Preterite of ANDAR', type:'pdf', level:'A2-B1', url:'free-pdf.html#card-andar-preterito', kw:'andar anduve anduviste anduvo anduvimos anduvisteis anduvieron preterito indefinido irregular verbo ande andamos ayer past tense preterite irregular verb estar raiz uv conjugacion' },
    { es:'ANDAMOS o ANDUVIMOS: el Pretérito Irregular de ANDAR', en:'ANDAMOS or ANDUVIMOS? The Irregular Preterite of ANDAR', type:'video', level:'A2-B1', url:'videos.html#video-andar-preterito-ef', kw:'andar anduve anduviste anduvo anduvimos anduvisteis anduvieron preterito indefinido irregular verbo ande andamos ayer past tense preterite irregular verb estar short errores frecuentes error comun nativos' },
    { es:'¿"Alante" o "Adelante"? Uno de los errores más comunes del español hablado', en:'"Alante" or "Adelante"? One of the Most Common Errors in Spoken Spanish', type:'pdf', level:'A2-B1', url:'free-pdf.html#card-adelante-ef', kw:'alante adelante palante pa\'lante hacia adelante seguir adelante sacar adelante de aqui en adelante error pronunciacion español hablado spoken mistake errores frecuentes' },
    { es:'¿"Alante" o "Adelante"? El error del español hablado', en:'"Alante" or "Adelante"? The Spoken Spanish Mistake', type:'video', level:'A2-B1', url:'videos.html#video-adelante-ef', kw:'alante adelante palante pa\'lante hacia adelante seguir adelante sacar adelante error pronunciacion español hablado spoken mistake short errores frecuentes error comun nativos' },
    { es:'¿"Espira" o "Expira"? Una sola letra... y puede ser fatal', en:'"Espira" or "Expira"? One Letter... And It Can Be Fatal', type:'video', level:'A2-B1', url:'videos.html#video-espira-expira-ef', kw:'espira expira espirar expirar respirar pronunciacion letra similar palabras confusas short errores frecuentes error comun' },
    { es:'¿"Espira" o "Expira"? La ficha del error', en:'"Espira" or "Expira"? The Common-Mistake Card', type:'pdf', level:'A2-B1', url:'free-pdf.html#card-espira-expira', kw:'espira expira espirar expirar inspirar respirar caducar morir plazo parónimos paronimos confusas errores frecuentes error comun nativos' },
    { es:'¿"Satisfació" o "Satisfizo"? El pretérito que hace dudar hasta a los nativos', en:'"Satisfació" or "Satisfizo"? The Preterite That Fools Even Natives', type:'video', level:'A2-B1', url:'videos.html#video-satisfacer', kw:'satisfacer satisfizo satisfice satisficiste satisficimos satisficisteis satisficieron satisfacio satisfacieron hacer hizo hice hicieron preterito indefinido irregular verbo short errores frecuentes error comun nativos' },
    { es:'¿"Satisfació" o "Satisfizo"? La ficha del error', en:'"Satisfació" or "Satisfizo"? The Common-Mistake Card', type:'pdf', level:'A2-B1', url:'free-pdf.html#card-satisfacer', kw:'satisfacer satisfizo satisfice satisficiste satisficimos satisficisteis satisficieron satisfacio satisfacieron hacer hizo hice hicieron satisfago satisfecho preterito indefinido irregular errores frecuentes error comun nativos' },
    { es:'¿"Contra más" o "Cuanto más"? El error que delata que aún no hablas un español cuidado', en:'"Contra más" or "Cuanto más"? The Mistake That Gives You Away', type:'video', level:'B1-B2', url:'videos.html#video-contra-mas', kw:'contra mas cuanto mas cuanta mas cuantos mas cuantas mas contimas contrimas cuantimas mientras mas entre mas comparativa proporcional vulgarismo error comun frecuente short' },
    { es:'¿"Contra más" o "Cuanto más"? La ficha del error', en:'"Contra más" or "Cuanto más"? The Common-Mistake Card', type:'pdf', level:'B1-B2', url:'free-pdf.html#card-contra-mas', kw:'contra mas cuanto mas cuanta mas cuantos mas cuantas mas contimas contrimas cuantimas mientras mas entre mas comparativa proporcional vulgarismo tilde acento error comun frecuente' },
    { es:'"Golazo" no es "un gol grande": el sufijo -AZO (1/4)', en:'"Golazo" Isn’t "A Big Goal": The Suffix -AZO (1/4)', type:'video', level:'B1-C1', url:'videos.html#video-azo', kw:'sufijo azo aumentativo intensificador golazo planazo fiestazo partidazo sueldazo cochazo multazo portazo aumentativos español vocabulario' },
    { es:'"Golazo" no es "un gol grande": el sufijo -AZO (1/4)', en:'"Golazo" Isn’t "A Big Goal": The Suffix -AZO (1/4)', type:'pdf', level:'B1-C1', url:'free-pdf.html#card-azo', kw:'sufijo azo aumentativo intensificador golazo planazo fiestazo partidazo sueldazo cochazo multazo portazo aumentativos español vocabulario ejercicios soluciones' },
    { es:'¿"Callaos" o "Callaros"? El error del imperativo de vosotros', en:'"Callaos" or "Callaros"? The Imperative Mistake', type:'video', level:'B1', url:'videos.html#video-callaos', kw:'callaos callaros callad imperativo vosotros os la d desaparece sentaos levantaos marchaos vestios idos iros error frecuente short imperative' },
    { es:'¿"Callaos" o "Callaros"? La ficha del error', en:'"Callaos" or "Callaros"? The Common-Mistake Card', type:'pdf', level:'B1', url:'free-pdf.html#card-callaos', kw:'callaos callaros callad imperativo vosotros regular verbos os la d desaparece sentaos levantaos marchaos vestios idos iros ejercicios errores frecuentes' },
    { es:'"Portazo" no es "una puerta impresionante": el sufijo -AZO (2/4)', en:'"Portazo" Isn’t "An Impressive Door": The Suffix -AZO (2/4)', type:'video', level:'B1-C1', url:'videos.html#video-azo-golpe', kw:'sufijo azo golpe portazo codazo cabezazo puñetazo manotazo balonazo sartenazo raquetazo bastonazo mazazo aumentativos español vocabulario' },
    { es:'"Portazo" no es "una puerta impresionante": el sufijo -AZO (2/4)', en:'"Portazo" Isn’t "An Impressive Door": The Suffix -AZO (2/4)', type:'pdf', level:'B1-C1', url:'free-pdf.html#card-azo-golpe', kw:'sufijo azo golpe portazo codazo cabezazo puñetazo manotazo balonazo sartenazo raquetazo bastonazo mazazo aumentativos español vocabulario ejercicios soluciones' },
    { es:'¿"Delante mía" o "delante de mí"? El error del posesivo', en:'"Delante mía" or "delante de mí"? The Possessive Mistake', type:'video', level:'A2-B1', url:'videos.html#video-delante-mia', kw:'delante mia delante de mi detras tuya encima suya cerca mio adverbios de lugar posesivo error frecuente comun nativos short adverb possessive mistake' },
    { es:'¿"Delante mía" o "delante de mí"? La ficha del error', en:'"Delante mía" or "delante de mí"? The Common-Mistake Card', type:'pdf', level:'A2-B1', url:'free-pdf.html#card-delante-mia', kw:'delante mia delante de mi detras tuya encima suya debajo enfrente cerca lejos alrededor dentro adverbios de lugar posesivo pronombre tonico error frecuente comun nativos adverb possessive mistake en mi contra a mi favor' },
    ...
    { es:'NOCHE: una palabra con familia', en:'NOCHE: A Word Family', type:'pdf', level:'A2-B1', url:'free-pdf.html#card-noche', kw:'noche medianoche trasnochar anochecer nocturno noctambulo nochevieja anoche pernoctar family word' },
    { es:'MEDIANOCHE, TRASNOCHAR, ANOCHECER, NOCTURNO, NOCHEVIEJA — Palabras de NOCHE', en:'MEDIANOCHE, TRASNOCHAR, ANOCHECER, NOCTURNO, NOCHEVIEJA — Words from NOCHE', type:'video', level:'A2-B1', url:'videos.html#video-noche', kw:'noche medianoche trasnochar anochecer nocturno noctambulo nochevieja anoche pernoctar' },
