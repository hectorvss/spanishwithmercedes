(function () {
  ...
  var INDEX = [
    ...
    { es:'Listen To, Wait For, Look For, Ask For — Sin Preposición en Español', en:'Listen To, Wait For, Look For, Ask For — No Preposition in Spanish', type:'video', level:'A2-B1', url:'videos.html#video-escuchar-esperar-buscar-pedir', kw:'listen to wait for look for ask for escuchar esperar buscar pedir sin preposicion calco del ingles verbos con preposicion en ingles y no en español' },
    { es:'Listen To, Wait For, Look For, Ask For — Sin Preposición en Español', en:'Listen To, Wait For, Look For, Ask For — No Preposition in Spanish', type:'pdf', level:'A2-B1', url:'free-pdf.html#card-verbos-sin-preposicion', kw:'listen to wait for look for ask for escuchar esperar buscar pedir sin preposicion calco del ingles ejercicios soluciones' },
