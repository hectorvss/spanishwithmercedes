(function () {
  ...
  var INDEX = [
    ...
    { es:'"Golazo" no es "un gol grande": el sufijo -AZO (1/3)', en:'"Golazo" Isn’t "A Big Goal": The Suffix -AZO (1/3)', type:'video', level:'B1-C1', url:'videos.html#video-azo', kw:'sufijo azo aumentativo intensificador golazo planazo fiestazo partidazo sueldazo cochazo multazo portazo aumentativos español vocabulario' },
    { es:'"Golazo" no es "un gol grande": el sufijo -AZO (1/3)', en:'"Golazo" Isn’t "A Big Goal": The Suffix -AZO (1/3)', type:'pdf', level:'B1-C1', url:'free-pdf.html#card-azo', kw:'sufijo azo aumentativo intensificador golazo planazo fiestazo partidazo sueldazo cochazo multazo portazo aumentativos español vocabulario ejercicios soluciones' },
