(function () {
  ...
  var INDEX = [
    ...
    { es:'¿"Alante" o "Adelante"? El error del español hablado', en:'"Alante" or "Adelante"? The Spoken Spanish Mistake', type:'video', level:'A2-B1', url:'videos.html#video-adelante', kw:'alante adelante palante pa\'lante hacia adelante seguir adelante sacar adelante error pronunciacion español hablado spoken mistake short' },
    { es:'¿"Espira" o "Expira"? Una sola letra... y puede ser fatal', en:'"Espira" or "Expira"? One Letter... And It Can Be Fatal', type:'video', level:'A2-B1', url:'videos.html#video-espira-expira', kw:'espira expira espirar expirar respirar pronunciacion letra similar palabras confusas short errores frecuentes error comun' },
